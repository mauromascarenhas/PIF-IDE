...
OutputBaseFilename=pif_ide-0.9.12_x86
...
Source: "C:\Users\Mauro\Documents\Completo\Extra\pifc\pif_compiler-0.9.08_x86.exe"; DestDir: "{tmp}"; Flags: deleteafterinstall; Components: pifc
...
Filename: "{tmp}\pif_compiler-0.9.08_x86.exe"; Parameters: "/VERYSILENT"; Description: "{cm:CompilerInstallDesc}"; StatusMsg: "{cm:InstallingCompiler}"; Flags: waituntilterminated skipifsilent; Components: pifc
